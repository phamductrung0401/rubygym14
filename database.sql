...
truncate trainer;
insert into trainer (id, avatar, name, sex, date_of_birth, phone_number, email, description, account_trainer_id) values (1, null, 'Karney Domone', 0, null, null, null, null, 1);
insert into trainer (id, avatar, name, sex, date_of_birth, phone_number, email, description, account_trainer_id) values (2, null, 'Vinni Whistan', 1, null, null, null, null, 2);
insert into trainer (id, avatar, name, sex, date_of_birth, phone_number, email, description, account_trainer_id) values (3, null, 'Randi O''Loughane', 2, '1990-11-03', '332-516-1544', 'roloughane2@salon.com', 'sit amet consectetuer adipiscing elit proin risus praesent lectus vestibulum quam sapien varius ut blandit non interdum in ante', 3);
insert into trainer (id, avatar, name, sex, date_of_birth, phone_number, email, description, account_trainer_id) values (4, 'data:image/png;base64,', 'Amos Sturdey', 1, '2003-01-17', '772-601-2742', 'asturdey3@nydailynews.com', 'in hac habitasse platea dictumst maecenas ut massa quis augue luctus tincidunt nulla mollis molestie lorem quisque ut erat', 4);
insert into trainer (id, avatar, name, sex, date_of_birth, phone_number, email, description, account_trainer_id) values (5, null, 'Leeanne Pee', 0, null, null, null, null, 5);
...
truncate student;
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (1, null, 'Haily Gaspar', 0, '1996-01-10', '125-416-6500', 'hgaspar0@upenn.edu', 'mauris vulputate elementum nullam varius nulla facilisi cras non velit nec nisi vulputate nonummy maecenas tincidunt lacus at', 80.06, 72.91, 10.84, 'sociis natoque penatibus et magnis dis parturient montes nascetur ridiculus mus', 'nonummy maecenas tincidunt lacus at velit vivamus vel nulla eget eros elementum', 1);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (2, null, 'Sosanna Mary', 1, '2017-02-01', '494-682-1385', 'smary1@hubpages.com', 'ipsum aliquam non mauris morbi non lectus aliquam sit amet diam in magna', 19.91, 74.68, 19.23, 'odio cras mi pede malesuada in imperdiet et commodo vulputate justo in blandit ultrices', 'egestas metus aenean fermentum donec ut mauris eget massa tempor convallis nulla neque libero convallis eget eleifend luctus ultricies', 2);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (3, null, 'Allianora Akehurst', 2, '1985-10-14', '376-779-1068', 'aakehurst2@shinystat.com', 'quam sapien varius ut blandit non interdum in ante vestibulum ante ipsum', 25.3, 13.43, 77.59, 'proin at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut', 'interdum in ante vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae duis', 3);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (4, null, 'Elwood Manolov', 1, '2006-06-03', '574-282-0222', 'emanolov3@a8.net', 'quam suspendisse potenti nullam porttitor lacus at turpis donec posuere metus', 87.55, 95.18, 89.14, 'eros viverra eget congue eget semper rutrum nulla nunc purus phasellus', 'nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at ipsum ac tellus', 4);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (5, null, 'Jeralee Gouldie', 1, null, null, null, null, null, null, null, null, null, 5);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (6, null, 'Joseph', 1, null, null, null, null, null, null, null, null, null, 6);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (7, null, 'David', 1, null, null, null, null, null, null, null, null, null, 7);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (8, null, 'Duckman', 1, null, null, null, null, null, null, null, null, null, 8);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (9, null, 'Solaris', 1, null, null, null, null, null, null, null, null, null, 9);
insert into student (id, avatar, name, sex, date_of_birth, phone_number, email, description, weight, height, bmi, others, target, account_student_id) values (10, null, 'Linus Tovalds', 1, null, null, null, null, null, null, null, null, null, 10);
...
truncate schedule;
insert into schedule (id, trainer_student_id, time_id) values (1, 1, 1);
